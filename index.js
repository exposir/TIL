...
const personalAccessToken = "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";
...
async function getRepoIssues() {
  try {
    ...
    fs.writeFileSync("issue.json", JSON.stringify(response.data));
...
// getRepoIssues(); // 获取仓库的 issue 列表
// getIssue(); // 获取单个 issue 的内容
updateIssue("Updated title", body); // 修改 issue 的内容
